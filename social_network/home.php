     ...
     <div id="head_wrap">
       ...
       <div class="content">
         ...
         <div id="content_timeline">
           <form id="f" action="home.php?id=<?php echo $user_id; ?>" method="post">
             <textarea name="content" rows="4" cols="83" placeholder="What's in your mind?"></textarea><br>
             <input type="submit" name="sub" value="Post" style="width:100px;">
           </form>
           <?php insertPost();//ovaa funkcija ke ja go vnese postot vo bazata ?>
           <center><h2>News Feed </h2></center>
           <?php get_posts(); //ovaa ke go prikazhe ?>
         </div>
       </div>
   </div>
 </body>
