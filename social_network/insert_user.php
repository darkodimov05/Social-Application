<?php
	...
	if(isset($_POST['sign_up'])){
		...
		$insert = "insert into users(user_name,describe_user,relationship,
		user_pass,user_email,user_country,user_gender,user_birthday,
		user_image,user_reg_date,status,ver_code,posts) values ('$name','Hello Social.I am new here',
		'........','$pass','$email','$country','$gender','$birthday','default.png',
		NOW(),'$status','$ver_code','$posts')";
