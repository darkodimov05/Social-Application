       ...
       <div class="content">
         ...
         <div id="message">
           <?php
            ...
            <form  action="messages.php?u_id=<?php echo $u_id; ?>" method="post" id="f"><br>
                <div style="background-color: green;padding: 20px;">
                  <center>
                      <h2>Subject</h2><br>
                      <input type="text" name="msg_title" placeholder="Hello Social" size="49"/>
                  </center>
                  <br><hr>
                </div>
                <div style="background-color: green;padding: 20px;">
                  <center>
                      <h2>Message</h2>
                      <textarea name="msg" rows="5" cols="50" placeholder="Leave Your Message"></textarea><br>
         ...
         <?php
          if (isset($_POST['message'])) {
            ...
            $insert = "insert into messages(sender,receiver,msg_sub,msg_topic,replay,status,msg_date)values('$user_id','$u_id','$msg_title','$msg','no_reply','unread',Now())";
            $run_insert = mysqli_query($conn,$insert);

            if ($run_insert) {
                echo "<script> alert('Message is sent to ".$user_name."')</script>";
            }else {
